...
const Color primarySwatchLight = Color.fromRGBO(0, 160, 141, 1.0); // r=0, g=160, b=141
const Color accentColorLight = Color.fromRGBO(44, 177, 119, 1.0); // r=44, g=177, b=119

// Primary swatch and accent color for dark theme
const Color primarySwatchDark = Color.fromRGBO(160, 155, 160, 1.0); // r=160, g=155, b=160
const Color accentColorDark = Color.fromRGBO(119, 170, 156, 1.0); // r=119, g=170, b=156
